...
LNM.EM <- function(W, X, base, EMiter = 10, EMburn = 5, MCiter = 1000, MCburn = 500, stepsize = 0.01, 
    ...
    return(list(b0 = b0.EM, b = b.EM, sigma = sigma.EM, acceptance = accept.EM, b0.list = b0.list, 
        b.list = b.list, sigma.list = sigma.list, acceptance.list = accept.list, Y = Y.p, base = base))
}
